...
class RawDataRecord
  RAW_DATA_PROVENANCE_REPOSITORY = Rails.application.config.raw_data_provenance_repository
  ...
  class << self
    ...
    def all_ids_for_entity(entity)
      RAW_DATA_PROVENANCE_REPOSITORY.raw_data_record_ids_for_entity(entity)
    end
